        ...
        <div>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className="event-form-div">
                    ...
                    <input name="event-capacity" type="number" min="1" />
                </div>
                <div className="event-form-div">
                    <label for="event-price">How much will it cost to attend this event?</label>
                    <input name="event-price" data-type="currency" />
                </div>
                <div className="event-form-div">
                    <p>When will the event take place?</p>
                    <div>
                        <label for="event-start-date">Start Date</label>
                        <input name="event-start-date" type="datetime-local" />
                    </div>
                    <div>
                        <label for="event-end-date">End Date</label>
                        <input name="event-end-date" type="datetime-local" />
                    </div>
                </div>
            </form>
        </div>
